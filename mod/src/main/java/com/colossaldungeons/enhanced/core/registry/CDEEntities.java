...
public class CDEEntities {
    ...
    // ===== Primordial Tower Dungeon Entities =====

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> PRIMAL_EMBER =
        ENTITIES.register("primal_ember", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.5f, 0.5f)
            .clientTrackingRange(8)
            .fireImmune()
            .build(ColossalDungeons.MOD_ID + ":primal_ember"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> ANCESTRAL_DROPLET =
        ENTITIES.register("ancestral_droplet", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.8f, 0.8f)
            .clientTrackingRange(8)
            .build(ColossalDungeons.MOD_ID + ":ancestral_droplet"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> OLD_GUST =
        ENTITIES.register("old_gust", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.6f, 0.6f)
            .clientTrackingRange(8)
            .build(ColossalDungeons.MOD_ID + ":old_gust"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> PRIMORDIAL_PEBBLE =
        ENTITIES.register("primordial_pebble", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.8f, 0.8f)
            .clientTrackingRange(8)
            .build(ColossalDungeons.MOD_ID + ":primordial_pebble"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> GENESIS_SPARK =
        ENTITIES.register("genesis_spark", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.6f, 0.6f)
            .clientTrackingRange(10)
            .build(ColossalDungeons.MOD_ID + ":genesis_spark"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> UNSTABLE_GOLEM =
        ENTITIES.register("unstable_golem", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(1.4f, 2.5f)
            .clientTrackingRange(12)
            .build(ColossalDungeons.MOD_ID + ":unstable_golem"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> CYCLE_CUSTODIAN =
        ENTITIES.register("cycle_custodian", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.8f, 2.0f)
            .clientTrackingRange(12)
            .build(ColossalDungeons.MOD_ID + ":cycle_custodian"));

    // ===== Primordial Tower Bosses =====

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> FIRST_WARDEN =
        ENTITIES.register("first_warden", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(1.5f, 3.0f)
            .clientTrackingRange(14)
            .build(ColossalDungeons.MOD_ID + ":first_warden"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> PRIMORDIAL_CONCORD =
        ENTITIES.register("primordial_concord", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(2.5f, 4.0f)
            .clientTrackingRange(16)
            .fireImmune()
            .build(ColossalDungeons.MOD_ID + ":primordial_concord"));

    // ===== Solar Palace Dungeon Entities =====

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> SOLAR_DANCER =
        ENTITIES.register("solar_dancer", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.6f, 1.8f)
            .clientTrackingRange(8)
            .build(ColossalDungeons.MOD_ID + ":solar_dancer"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> GILDED_GUARD =
        ENTITIES.register("gilded_guard", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.8f, 2.0f)
            .clientTrackingRange(8)
            .build(ColossalDungeons.MOD_ID + ":gilded_guard"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> BRAZIER_IGNEOUS =
        ENTITIES.register("brazier_igneous", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.6f, 0.8f)
            .clientTrackingRange(8)
            .fireImmune()
            .build(ColossalDungeons.MOD_ID + ":brazier_igneous"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> BRONZE_FALCON =
        ENTITIES.register("bronze_falcon", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.8f, 0.6f)
            .clientTrackingRange(10)
            .build(ColossalDungeons.MOD_ID + ":bronze_falcon"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> BURNING_STANDARD =
        ENTITIES.register("burning_standard", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.6f, 1.8f)
            .clientTrackingRange(8)
            .build(ColossalDungeons.MOD_ID + ":burning_standard"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> SOLAR_MIRROR_COLOSSUS =
        ENTITIES.register("solar_mirror_colossus", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(1.8f, 3.0f)
            .clientTrackingRange(12)
            .build(ColossalDungeons.MOD_ID + ":solar_mirror_colossus"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> DAWN_PRIESTESS =
        ENTITIES.register("dawn_priestess", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(0.6f, 1.8f)
            .clientTrackingRange(12)
            .build(ColossalDungeons.MOD_ID + ":dawn_priestess"));

    // ===== Solar Palace Bosses =====

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> NOON_GUARDIAN =
        ENTITIES.register("noon_guardian", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(1.8f, 3.5f)
            .clientTrackingRange(14)
            .build(ColossalDungeons.MOD_ID + ":noon_guardian"));

    public static final DeferredHolder<EntityType<?>, EntityType<PathfinderMob>> CHAINED_HELIOS =
        ENTITIES.register("chained_helios", () -> EntityType.Builder.of(PathfinderMob::new, MobCategory.MONSTER)
            .sized(3.0f, 3.0f)
            .clientTrackingRange(16)
            .fireImmune()
            .build(ColossalDungeons.MOD_ID + ":chained_helios"));
